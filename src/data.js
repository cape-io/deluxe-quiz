export default {
  "author": "Deluxe Marketing Services for Customer Insights",
  ...
  "intro": "Do you truly understand your account holders’ needs and perceptions? Are you gathering the key drivers that matter to your account holders, allowing you to take action?\n",
  "lead": "TAKE THIS QUICK QUIZ TO FIND OUT.",
  "questions": [
    {
      "id": "account-holders",
      "text": "Are you surveying account holders about their experience in multiple channels: in branch, on the phone, in the drive-through, online and via mobile access?\n"
    },
    {
      "id": "loan",
  ...
  "scores": [
    {
      ...
      "header": "Our customer insights solution goes beyond traditional customer satisfaction efforts to deliver results that are truly meaningful to financial institutions including",
      "points": [
    ...
    },
    {
      ...
      "lead": [
        "Nice start.",
        "Now let’s figure out how you can get a 360° view of what’s really important."
      ],
    ...
    },
    {
      ...
      "header": "With an approach tailored to financial institutions, our customer insights solution can help you implement a customer satisfaction program that",
      "points": [
